#
#  Be sure to run `pod spec lint F53OSC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    * based on the work created by Figure 53 & modified by cpmpercussion
  ...
  # s.author             = { "Jay Konopka" => "konopka@gmail.com" }
  s.authors              = { "Figure53" => "support@figure53.com" , "Jay Konopka" => "jay@disappointedpig.com" }
  
  # Or just: s.author    = "Jay Konopka"
  # s.authors            = { "Jay Konopka" => "konopka@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Jay Konopka"
  ...
  s.source       = { :git => "https://github.com/jkonopka/F53OSC.git", :tag => "1.0.0" }
